// ============================================================
// Wordweeper — Console Test Harness (run with: node test_engine.cjs)
// ============================================================
...
if (failed === 0) {
  console.log('  \x1b[32mAll tests passed — engine ready.\x1b[0m\n');
} else {
